        ...
        <div class="container mt-5">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form action="{{ route('detailservice.update', $detailservice->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control main w-25" name="pelanggan_id">
                                ...
                                @foreach ($pelanggan as $plgn)
                                    <option value="{{ $plgn->id }}"
                                        {{ $detailservice->pelanggan_id == $plgn->id ? 'selected' : '' }}>
                                        {{ $plgn->nama_pelanggan }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_service" class="form-control"
                                value="{{ $detailservice->tanggal_service }}">
                        </div>
                        <div class="form-group">
                            <label>Jam Masuk</label>
                            <input type="time" name="jam_masuk" class="form-control"
                                value="{{ $detailservice->jam_masuk }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control main w-25" name="service_id">
                                ...
                                @foreach ($service as $srv)
                                    <option value="{{ $srv->id }}"
                                        {{ $detailservice->service_id == $srv->id ? 'selected' : '' }}>
                                        {{ $srv->nama_service }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Sparepart</label>
                            <input type="text" name="spare_part" class="form-control"
                                value="{{ $detailservice->spare_part }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="total_harga" class="form-control"
                                value="{{ $detailservice->total_harga }}">
                        </div>
